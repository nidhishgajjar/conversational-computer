...
pub mod zwp_primary_selection_device_manager_v1 {
    ...
    pub enum Request {
        ...
        CreateSource {
            id: Main<super::zwp_primary_selection_source_v1::ZwpPrimarySelectionSourceV1>,
        },
        #[doc = "create a new primary selection device\n\nCreate a new data device for a given seat."]
        GetDevice {
            id: Main<super::zwp_primary_selection_device_v1::ZwpPrimarySelectionDeviceV1>,
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                0 => {
                    ...
                    Ok(Request::CreateSource {
                        id: {
                            let me = Resource::<ZwpPrimarySelectionDeviceManagerV1>::from_c_ptr(
                                obj as *mut _,
                            );
                            me . make_child_for :: < super :: zwp_primary_selection_source_v1 :: ZwpPrimarySelectionSourceV1 > (_args [0] . n) . unwrap ()
                        },
                    })
                }
                1 => {
                    ...
                    Ok(Request::GetDevice {
                        id: {
                            ...
                            me . make_child_for :: < super :: zwp_primary_selection_device_v1 :: ZwpPrimarySelectionDeviceV1 > (_args [0] . n) . unwrap ()
                        },
    ...
    pub struct ZwpPrimarySelectionDeviceManagerV1(Resource<ZwpPrimarySelectionDeviceManagerV1>);
    impl AsRef<Resource<ZwpPrimarySelectionDeviceManagerV1>> for ZwpPrimarySelectionDeviceManagerV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZwpPrimarySelectionDeviceManagerV1>> for ZwpPrimarySelectionDeviceManagerV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZwpPrimarySelectionDeviceManagerV1(value)
        }
    }
    impl From<ZwpPrimarySelectionDeviceManagerV1> for Resource<ZwpPrimarySelectionDeviceManagerV1> {
        #[inline]
...
pub mod zwp_primary_selection_device_v1 {
                ...
                0 => {
                    ...
                    Ok(Request::SetSelection {
                        source: if _args[0].o.is_null() {
                            ...
                            Some (Resource :: < super :: zwp_primary_selection_source_v1 :: ZwpPrimarySelectionSourceV1 > :: from_c_ptr (_args [0] . o as * mut _ ,) . into ())
                        },
                        serial: _args[1].u,
                    })
                }
    ...
    pub enum Event {
        ...
        DataOffer {
            offer: Resource<super::zwp_primary_selection_offer_v1::ZwpPrimarySelectionOfferV1>,
        },
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZwpPrimarySelectionDeviceV1(Resource<ZwpPrimarySelectionDeviceV1>);
    impl AsRef<Resource<ZwpPrimarySelectionDeviceV1>> for ZwpPrimarySelectionDeviceV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZwpPrimarySelectionDeviceV1>> for ZwpPrimarySelectionDeviceV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZwpPrimarySelectionDeviceV1(value)
        }
    }
    impl From<ZwpPrimarySelectionDeviceV1> for Resource<ZwpPrimarySelectionDeviceV1> {
        #[inline]
...
pub mod zwp_primary_selection_offer_v1 {
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZwpPrimarySelectionOfferV1(Resource<ZwpPrimarySelectionOfferV1>);
    impl AsRef<Resource<ZwpPrimarySelectionOfferV1>> for ZwpPrimarySelectionOfferV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZwpPrimarySelectionOfferV1>> for ZwpPrimarySelectionOfferV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZwpPrimarySelectionOfferV1(value)
        }
    }
    impl From<ZwpPrimarySelectionOfferV1> for Resource<ZwpPrimarySelectionOfferV1> {
        #[inline]
...
pub mod zwp_primary_selection_source_v1 {
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZwpPrimarySelectionSourceV1(Resource<ZwpPrimarySelectionSourceV1>);
    impl AsRef<Resource<ZwpPrimarySelectionSourceV1>> for ZwpPrimarySelectionSourceV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZwpPrimarySelectionSourceV1>> for ZwpPrimarySelectionSourceV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZwpPrimarySelectionSourceV1(value)
        }
    }
    impl From<ZwpPrimarySelectionSourceV1> for Resource<ZwpPrimarySelectionSourceV1> {
        #[inline]
