...
pub mod zwlr_foreign_toplevel_manager_v1 {
    ...
    pub enum Event {
        ...
        Toplevel {
            toplevel: Resource<super::zwlr_foreign_toplevel_handle_v1::ZwlrForeignToplevelHandleV1>,
        },
    ...
    impl super::MessageGroup for Event {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                Event::Toplevel { toplevel } => Message {
                    sender_id: sender_id,
                    opcode: 0,
                    args: smallvec![Argument::NewId(toplevel.id()),],
                },
            ...
            F: FnOnce(u32, &mut [wl_argument]) -> T,
        {
            match self {
                Event::Toplevel { toplevel } => {
                    ...
                    _args_array[0].o = toplevel.c_ptr() as *mut _;
                    f(0, &mut _args_array)
                }
                Event::Finished => {
    ...
    pub struct ZwlrForeignToplevelManagerV1(Resource<ZwlrForeignToplevelManagerV1>);
    impl AsRef<Resource<ZwlrForeignToplevelManagerV1>> for ZwlrForeignToplevelManagerV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZwlrForeignToplevelManagerV1>> for ZwlrForeignToplevelManagerV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZwlrForeignToplevelManagerV1(value)
        }
    }
    impl From<ZwlrForeignToplevelManagerV1> for Resource<ZwlrForeignToplevelManagerV1> {
        #[inline]
    ...
    impl ZwlrForeignToplevelManagerV1 {
        ...
        pub fn toplevel(
            &self,
            toplevel: &super::zwlr_foreign_toplevel_handle_v1::ZwlrForeignToplevelHandleV1,
        ) -> () {
            let msg = Event::Toplevel {
                toplevel: toplevel.as_ref().clone(),
            };
            self.0.send(msg);
        }
        #[doc = "the compositor has finished with the toplevel manager\n\nThis event indicates that the compositor is done sending events to the\nzwlr_foreign_toplevel_manager_v1. The server will destroy the object\nimmediately after sending this request, so it will become invalid and\nthe client should free any resources associated with it."]
...
pub mod zwlr_foreign_toplevel_handle_v1 {
    ...
    impl super::MessageGroup for Request {
        ...
        fn from_raw(msg: Message, map: &mut Self::Map) -> Result<Self, ()> {
            match msg.opcode {
                0 => Ok(Request::SetMaximized),
                1 => Ok(Request::UnsetMaximized),
                2 => Ok(Request::SetMinimized),
                3 => Ok(Request::UnsetMinimized),
                4 => {
    ...
    impl super::MessageGroup for Event {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Event::OutputEnter { output } => Message {
                    sender_id: sender_id,
                    opcode: 2,
                    args: smallvec![Argument::Object(output.as_ref().id()),],
                },
                Event::OutputLeave { output } => Message {
                    sender_id: sender_id,
                    opcode: 3,
                    args: smallvec![Argument::Object(output.as_ref().id()),],
                },
                Event::State { state } => Message {
                    sender_id: sender_id,
                    opcode: 4,
                    args: smallvec![Argument::Array(Box::new(state)),],
                },
                Event::Done => Message {
                    sender_id: sender_id,
                    opcode: 5,
            ...
            F: FnOnce(u32, &mut [wl_argument]) -> T,
        {
            match self {
                ...
                Event::State { state } => {
                    ...
                    let _arg_0 = wl_array {
                        size: state.len(),
                        alloc: state.capacity(),
                        data: state.as_ptr() as *mut _,
                    };
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZwlrForeignToplevelHandleV1(Resource<ZwlrForeignToplevelHandleV1>);
    impl AsRef<Resource<ZwlrForeignToplevelHandleV1>> for ZwlrForeignToplevelHandleV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZwlrForeignToplevelHandleV1>> for ZwlrForeignToplevelHandleV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZwlrForeignToplevelHandleV1(value)
        }
    }
    impl From<ZwlrForeignToplevelHandleV1> for Resource<ZwlrForeignToplevelHandleV1> {
        #[inline]
    ...
    impl ZwlrForeignToplevelHandleV1 {
        ...
        pub fn title(&self, title: String) -> () {
            let msg = Event::Title { title: title };
            self.0.send(msg);
        }
        #[doc = "app-id change\n\nThis event is emitted whenever the app-id of the toplevel changes."]
        pub fn app_id(&self, app_id: String) -> () {
            let msg = Event::AppId { app_id: app_id };
            self.0.send(msg);
        }
        #[doc = "toplevel entered an output\n\nThis event is emitted whenever the toplevel becomes visible on\nthe given output. A toplevel may be visible on multiple outputs."]
        pub fn output_enter(&self, output: &super::wl_output::WlOutput) -> () {
            let msg = Event::OutputEnter {
                output: output.clone(),
            };
            self.0.send(msg);
        }
        #[doc = "toplevel left an output\n\nThis event is emitted whenever the toplevel stops being visible on\nthe given output. It is guaranteed that an entered-output event\nwith the same output has been emitted before this event."]
        pub fn output_leave(&self, output: &super::wl_output::WlOutput) -> () {
            let msg = Event::OutputLeave {
                output: output.clone(),
            };
            self.0.send(msg);
        }
        ...
        pub fn state(&self, state: Vec<u8>) -> () {
            let msg = Event::State { state: state };
            self.0.send(msg);
        }
        #[doc = "all information about the toplevel has been sent\n\nThis event is sent after all changes in the toplevel state have been\nsent.\n\nThis allows changes to the zwlr_foreign_toplevel_handle_v1 properties\nto be seen as atomic, even if they happen via multiple events."]
        pub fn done(&self) -> () {
