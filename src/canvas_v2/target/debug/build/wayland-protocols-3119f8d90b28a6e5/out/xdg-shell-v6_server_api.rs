...
pub mod zxdg_shell_v6 {
    ...
    pub enum Request {
        ...
        CreatePositioner {
            id: Main<super::zxdg_positioner_v6::ZxdgPositionerV6>,
        },
        ...
        GetXdgSurface {
            id: Main<super::zxdg_surface_v6::ZxdgSurfaceV6>,
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                1 => {
                    ...
                    Ok(Request::CreatePositioner {
                        id: {
                            let me = Resource::<ZxdgShellV6>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::zxdg_positioner_v6::ZxdgPositionerV6>(
                                _args[0].n,
                            )
                            .unwrap()
                        },
                ...
                2 => {
                    ...
                    Ok(Request::GetXdgSurface {
                        id: {
                            let me = Resource::<ZxdgShellV6>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::zxdg_surface_v6::ZxdgSurfaceV6>(_args[0].n)
                                .unwrap()
                        },
    ...
    pub struct ZxdgShellV6(Resource<ZxdgShellV6>);
    impl AsRef<Resource<ZxdgShellV6>> for ZxdgShellV6 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZxdgShellV6>> for ZxdgShellV6 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZxdgShellV6(value)
        }
    }
    impl From<ZxdgShellV6> for Resource<ZxdgShellV6> {
        #[inline]
...
pub mod zxdg_positioner_v6 {
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZxdgPositionerV6(Resource<ZxdgPositionerV6>);
    impl AsRef<Resource<ZxdgPositionerV6>> for ZxdgPositionerV6 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZxdgPositionerV6>> for ZxdgPositionerV6 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZxdgPositionerV6(value)
        }
    }
    impl From<ZxdgPositionerV6> for Resource<ZxdgPositionerV6> {
        #[inline]
...
pub mod zxdg_surface_v6 {
    ...
    pub enum Request {
        ...
        GetToplevel {
            id: Main<super::zxdg_toplevel_v6::ZxdgToplevelV6>,
        },
        #[doc = "assign the xdg_popup surface role\n\nThis creates an xdg_popup object for the given xdg_surface and gives the\nassociated wl_surface the xdg_popup role.\n\nSee the documentation of xdg_popup for more details about what an\nxdg_popup is and how it is used."]
        GetPopup {
            id: Main<super::zxdg_popup_v6::ZxdgPopupV6>,
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                1 => {
                    ...
                    Ok(Request::GetToplevel {
                        id: {
                            let me = Resource::<ZxdgSurfaceV6>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::zxdg_toplevel_v6::ZxdgToplevelV6>(_args[0].n)
                                .unwrap()
                        },
                    })
                }
                2 => {
                    ...
                    Ok(Request::GetPopup {
                        id: {
                            let me = Resource::<ZxdgSurfaceV6>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::zxdg_popup_v6::ZxdgPopupV6>(_args[0].n)
                                .unwrap()
                        },
                        parent: Resource::<super::zxdg_surface_v6::ZxdgSurfaceV6>::from_c_ptr(
                            _args[1].o as *mut _,
                        )
                        .into(),
                        positioner:
                            Resource::<super::zxdg_positioner_v6::ZxdgPositionerV6>::from_c_ptr(
                                _args[2].o as *mut _,
                            )
                            .into(),
                    })
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZxdgSurfaceV6(Resource<ZxdgSurfaceV6>);
...
pub mod zxdg_toplevel_v6 {
                ...
                1 => {
                    ...
                    Ok(Request::SetParent {
                        parent: if _args[0].o.is_null() {
                            ...
                            Some(
                                Resource::<super::zxdg_toplevel_v6::ZxdgToplevelV6>::from_c_ptr(
                                    _args[0].o as *mut _,
                                )
                                .into(),
                            )
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZxdgToplevelV6(Resource<ZxdgToplevelV6>);
...
pub mod zxdg_popup_v6 {
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZxdgPopupV6(Resource<ZxdgPopupV6>);
