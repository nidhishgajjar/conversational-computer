...
pub mod zxdg_decoration_manager_v1 {
    ...
    pub enum Request {
        ...
        GetToplevelDecoration {
            id: Main<super::zxdg_toplevel_decoration_v1::ZxdgToplevelDecorationV1>,
        ...
        fn from_raw(msg: Message, map: &mut Self::Map) -> Result<Self, ()> {
            match msg.opcode {
                ...
                1 => {
                    ...
                    Ok(Request::GetToplevelDecoration {
                        id: {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                1 => {
                    ...
                    Ok(Request::GetToplevelDecoration {
                        id: {
                            let me = Resource::<ZxdgDecorationManagerV1>::from_c_ptr(obj as *mut _);
                            me . make_child_for :: < super :: zxdg_toplevel_decoration_v1 :: ZxdgToplevelDecorationV1 > (_args [0] . n) . unwrap ()
                        },
                        toplevel: Resource::<super::xdg_toplevel::XdgToplevel>::from_c_ptr(
                            _args[1].o as *mut _,
                        )
                        .into(),
                    })
    ...
    pub struct ZxdgDecorationManagerV1(Resource<ZxdgDecorationManagerV1>);
    impl AsRef<Resource<ZxdgDecorationManagerV1>> for ZxdgDecorationManagerV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZxdgDecorationManagerV1>> for ZxdgDecorationManagerV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZxdgDecorationManagerV1(value)
        }
    }
    impl From<ZxdgDecorationManagerV1> for Resource<ZxdgDecorationManagerV1> {
        #[inline]
...
pub mod zxdg_toplevel_decoration_v1 {
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct ZxdgToplevelDecorationV1(Resource<ZxdgToplevelDecorationV1>);
    impl AsRef<Resource<ZxdgToplevelDecorationV1>> for ZxdgToplevelDecorationV1 {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<ZxdgToplevelDecorationV1>> for ZxdgToplevelDecorationV1 {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            ZxdgToplevelDecorationV1(value)
        }
    }
    impl From<ZxdgToplevelDecorationV1> for Resource<ZxdgToplevelDecorationV1> {
        #[inline]
    ...
    impl ZxdgToplevelDecorationV1 {
        ...
        pub fn configure(&self, mode: Mode) -> () {
            let msg = Event::Configure { mode: mode };
            self.0.send(msg);
        }
    }
    #[doc = r" The minimal object version supporting this request"]
